...
//     language and it shows that adding a new item to the input list is not going to work, even though the 
//     parameter is passed by value, but the value is poining to the reference of list and any change on parameter will be 
//     seen by caller)
